...
public class ExportExcelBean {
    ...
    public String toString()
    {
        ...
        stringBuffer.append(SysConst.LINE_SEPARATOR).append(">>>>ExportExcelBean bean");
        stringBuffer.append(SysConst.LINE_SEPARATOR).append("fileName = ").append(this.fileName);
        stringBuffer.append(SysConst.LINE_SEPARATOR).append("fileTitle = ").append(this.fileTitle);
        stringBuffer.append(SysConst.LINE_SEPARATOR).append("ExportExcelBean bean<<<<");
