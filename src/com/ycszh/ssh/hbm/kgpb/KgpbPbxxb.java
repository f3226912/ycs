...
/**
 * KgpbPbxxb entity. @author MyEclipse Persistence Tools
 */

public class KgpbPbxxb extends BaseObject {
    ...
    /** full constructor */
    public KgpbPbxxb(String kgid, String kcid, Date pbrq, String bz, String czr, String czrxm, String czrbm, String czrkjbm, String czip, Date czsj, String cznr) {
        this.kgid = kgid;
        this.kcid = kcid;
        this.pbrq = pbrq;
        this.bz = bz;
