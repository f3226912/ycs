...
/**
 * PdasmycChbaseLog entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class PdasmycChbaseLog extends BaseObject {
	...
	/** default constructor */
	public PdasmycChbaseLog() {
	}

	/** minimal constructor */
	public PdasmycChbaseLog(String id) {
		this.id = id;
	}

	/** full constructor */
	public PdasmycChbaseLog(String id, String chid, String chmm, String chmc,
			...
			Date tranDate, String synFlag, String tranFlag, String czr,
