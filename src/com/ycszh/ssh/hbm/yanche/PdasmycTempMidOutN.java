...
/**
 * PdasmycTempMidOutN entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class PdasmycTempMidOutN extends BaseObject {
	...
	public String nexm;
	public String neyjdz;
	public String neyzbm;
	public String nelxdh;
	public String nedzxx;
	public String nejbrxm;
	public String nejbrlxdh;
	public String chid;
	public Date chrq;
	...
	public String poszj;
	public String postp;
	public String possjr;
	public String poslxdh;
	public String posyjdz;
	public String posyzbm;
	public String ctccs;
	...
	/** default constructor */
	public PdasmycTempMidOutN() {
	}

	/** minimal constructor */
	public PdasmycTempMidOutN(String xh, String clsbdh, String lsh) {
		this.xh = xh;
		this.clsbdh = clsbdh;
		this.lsh = lsh;
	}
	...
	/** full constructor */
	public PdasmycTempMidOutN(String xh, String hpzl, String hphm,
			...
			String lsh, String fdjxh, String rlzl, Integer pl, Double gl,
			String zxxs, Integer cwkc, Integer cwkk, Integer cwkg, Integer hxnbcd,
			Integer hxnbkd, Integer hxnbgd, Integer gbthps, Integer zs, Integer zj,
			Integer qlj, Integer hlj, String ltgg, Integer lts, Integer zzl,
			Integer zbzl, Integer hdzzl, Integer hdzk, Integer zqyzl,
			Integer qpzk, Integer hpzk, String bh, String dpid, String hbdbqk,
			Date ccrq, String hdfs, String llpz1, String pzbh1, String llpz2,
			String pzbh2, String xsdw, Integer xsjg, Date xsrq, String jkpz,
			String jkpzhm, String hgzbh, String nszm, String nszmbh,
			String xgzl, String qmbh, String hmbh, String bz, String cjdw,
			String jyjg, String bxpzh, Integer bxje, Date sxrq, Date zzrq,
			String bxgs, String yhpzl, String yhphm, String ysyxz, String zcd,
			String jcjgzms, String zylx, String bgnr, String hdid, Integer bzcs,
			Integer bpcs, Integer bdjcs, Integer zdjzshs, Date qzrq, String sfzmmc,
			String syr, String zsxzqh, String zsxxdz, String yzbm1,
			String lxdh, String zzz, String zzxzqh, String zzxxdz,
			String yzbm2, String ywlx, String ywyy, String jyw, String cyry,
			String dphgzbh, String dzyx, String xszbh, String sjhm,
			String jyhgbzbh, String localIshandle, String localOperat,
			Date localOpertime, String localName, String nexm, String neyjdz,
			String neyzbm, String nelxdh, String nedzxx, String nejbrxm,
			String nejbrlxdh, String chid, Date chrq, String sfxzyc,
			String ouin, String md5, String synFlag, String tranFlag,
			Date tranDate, String refeshFlag, String refeshMsg,
			Date refeshDate, String nefph, String poszj, String postp,
			String possjr, String poslxdh, String posyjdz, String posyzbm,
			String ctccs, String tempBz1, String tempBz2, String tempBz3,
			String tempBz4, String tempBz5, String dbyzh, String tyzxh,
			String netXm, String netYjdz, String netYzbm, String netLxdh,
			String netDzxx, String netJbrxm, String netJbrlxdh, String outIn,
			String netFph, String postZj, String postTp, String postSjr,
			String postLxdh, String postYjdz, String postYzbm, String smycLsh) {
		this.xh = xh;
		this.hpzl = hpzl;
		this.hphm = hphm;
		this.clpp1 = clpp1;
		...
		this.nelxdh = nelxdh;
		this.nedzxx = nedzxx;
		this.nejbrxm = nejbrxm;
		this.nejbrlxdh = nejbrlxdh;
		this.chid = chid;
		this.chrq = chrq;
		this.sfxzyc = sfxzyc;
		this.ouin = ouin;
		...
		this.postp = postp;
		this.possjr = possjr;
		this.poslxdh = poslxdh;
		this.posyjdz = posyjdz;
		this.posyzbm = posyzbm;
		this.ctccs = ctccs;
	...
	public void setBxje(Integer bxje) {
		this.bxje = bxje;
	}
	...
	public String getNexm() {
		return this.nexm;
	}

	public void setNexm(String nexm) {
		this.nexm = nexm;
	}

	public String getNeyjdz() {
		return this.neyjdz;
	}

	public void setNeyjdz(String neyjdz) {
		this.neyjdz = neyjdz;
	}

	public String getNeyzbm() {
		return this.neyzbm;
	}

	public void setNeyzbm(String neyzbm) {
		this.neyzbm = neyzbm;
	}

	public String getNelxdh() {
		return this.nelxdh;
	}

	public void setNelxdh(String nelxdh) {
		this.nelxdh = nelxdh;
	}

	public String getNedzxx() {
		return this.nedzxx;
	}

	public void setNedzxx(String nedzxx) {
		this.nedzxx = nedzxx;
	}

	public String getNejbrxm() {
		return this.nejbrxm;
	}

	public void setNejbrxm(String nejbrxm) {
		this.nejbrxm = nejbrxm;
	}

	public String getNejbrlxdh() {
		return this.nejbrlxdh;
	}

	public void setNejbrlxdh(String nejbrlxdh) {
		this.nejbrlxdh = nejbrlxdh;
	}
	...
	public String getOuin() {
		return this.ouin;
	}

	public void setOuin(String ouin) {
		this.ouin = ouin;
	}
	...
	public String getNefph() {
		return this.nefph;
	}

	public void setNefph(String nefph) {
		this.nefph = nefph;
	}

	public String getPoszj() {
		return this.poszj;
	}

	public void setPoszj(String poszj) {
		this.poszj = poszj;
	}
	...
	public String getPossjr() {
		return this.possjr;
	}

	public void setPossjr(String possjr) {
		this.possjr = possjr;
	}

	public String getPoslxdh() {
		return this.poslxdh;
	}

	public void setPoslxdh(String poslxdh) {
		this.poslxdh = poslxdh;
	}

	public String getPosyjdz() {
		return this.posyjdz;
	}

	public void setPosyjdz(String posyjdz) {
		this.posyjdz = posyjdz;
	}

	public String getPosyzbm() {
		return this.posyzbm;
	}

	public void setPosyzbm(String posyzbm) {
		this.posyzbm = posyzbm;
	}
