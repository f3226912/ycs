...
/**
 * BusVehicleBaseLog entity. @author MyEclipse Persistence Tools
 */

public class BusVehicleBaseLog implements java.io.Serializable {
	...
	public Blob getXszzp() {
		return xszzp;
	}

	public void setXszzp(Blob xszzp) {
		this.xszzp = xszzp;
	}
