...
/**
 * VehicleTempMidIn entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class VehicleTempMidTest extends BaseObject {
	...
	/** default constructor */
	public VehicleTempMidTest() {
	}

	/** minimal constructor */
	public VehicleTempMidTest(String lsh, String xh, String clsbdh) {
		this.lsh = lsh;
		this.xh = xh;
		this.clsbdh = clsbdh;
	}
	...
	/** full constructor */
	public VehicleTempMidTest(String lsh, String xh, String hpzl, String hphm,
			...
			String synFlag, String tranFlag, Date tranDate, String netFph,
			String postZj, String postTp, String postSjr, String postLxdh,
			String postYjdz, String postYzbm, String ctccs, String tempBz1,
			String tempBz2, String tempBz3, String tempBz4, String tempBz5,
			String tybLsh) {
		this.lsh = lsh;
		this.xh = xh;
		this.hpzl = hpzl;
	...
	public String getNetSfzmhm() {
		return netSfzmhm;
	}

	public void setNetSfzmhm(String netSfzmhm) {
		this.netSfzmhm = netSfzmhm;
	}
