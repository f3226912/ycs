...
/**
 * SfrzCjxxbLog entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class SfrzCjxxbLog extends BaseObject {
	...
	/** minimal constructor */
	public SfrzCjxxbLog(String xh) {
		this.xh = xh;
	}

	/** full constructor */
	public SfrzCjxxbLog(String xh, String cid, String xm, String sfzmmc,
			String sfzmhm, String xb, String gj, String mz, String jg,
			String txdz, String dzyx, String gddh, String yddh, String wx,
			String wb, String qq, String rzly, String rzjs, String czxm,
			String czsfzmhm, String hphm, String hpzl, String dsrSfzCardname1,
			...
			String synFlag, Date tranDate, String tranFlag, String czr,
			String czrxm, String czrbm, Date czsj, String czip, String czmac,
			String cznr, String isBand, String czsfzmmc) {
		this.xh = xh;
		this.cid = cid;
		this.xm = xm;
		this.sfzmmc = sfzmmc;
