...
public class WtydnsYwsbspbDaoImpl extends BaseDaoImpl<WtydnsYwsbspb, Integer> implements WtydnsYwsbspbDao{
	...
	@Override
	public WtydnsYwsbspb getRepository(Integer pk) {
		return super.getHibernateTemplate().get(WtydnsYwsbspb.class, pk);
	}
	/***
	 * 批次查询
	 */
