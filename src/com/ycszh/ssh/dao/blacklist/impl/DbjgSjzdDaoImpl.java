 ...
 * @文件名:DbjgSjzdDaoImpl.java
 * @描述:
 * @版本:V 1.0
 */
public class DbjgSjzdDaoImpl extends BaseDaoImpl<DbjgSjzd, String> implements DbjgSjzdDao {

	@Override
	public DbjgSjzd getRepository(String pk) throws Exception {
		return super.getHibernateTemplate().get(DbjgSjzd.class, pk);
	}
	
	@SuppressWarnings("unchecked")
	public int getSize(String sql) throws Exception {
		List<DbjgSjzd> list = this.getHibernateTemplate().find(sql);
		return list.size();
	}
	/**
	 * 受托核发检验合格标志机构(stjg)
