...
public class SlgDrvFileUploadDaoImpl extends HibernateDaoSupport implements SlgDrvFileUploadDao{
	...
	public static void main(String[] args) {
		SlgDrvFileUploadDaoImpl ss = new SlgDrvFileUploadDaoImpl();
		try {
			String ssf = ss.uploadFile(new File("c://printtx.jpg"));
