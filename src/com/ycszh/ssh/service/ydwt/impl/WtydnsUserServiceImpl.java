...
import com.ycszh.ssh.service.ydwt.WtydnsUserService;

public class WtydnsUserServiceImpl implements WtydnsUserService {
	
	private WtydnsUserDao  wtydnsUserDao;
	private final static Logger log = Logger.getLogger(WtydnsUserServiceImpl.class);
