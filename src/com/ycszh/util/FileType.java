...
public enum FileType {  
    ...
    */  
     ...
     * @throws IOException
     */
    public static FileType getType(InputStream filePath) throws IOException{
     ...
     * @throws IOException
     */
    private static String getFileContent(InputStream filePath) throws IOException{
		byte[] b = new byte[28];
		InputStream inputstream =null;
		try {
			filePath.read(b, 0, 28);
		} catch (IOException e) {
			e.printStackTrace();
			throw e;
		} finally {
    ...
    public static Integer isFileType(FileType value) {  
        ...
        // 文档格式
        FileType[] docs = { FileType.RTF,FileType.TXT, FileType.XML, FileType.HTML, FileType.CSS, FileType.JS, FileType.EML, FileType.DBX, FileType.PST, FileType.XLS_DOC, FileType.XLSX_DOCX, FileType.VSD,  
