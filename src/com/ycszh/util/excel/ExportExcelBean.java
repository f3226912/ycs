...
public class ExportExcelBean {
    ...
    private String fileFisrtRowTitle;
	...
	public String getFileFisrtRowTitle() {
		return fileFisrtRowTitle;
	}

	public void setFileFisrtRowTitle(String fileFisrtRowTitle) {
		this.fileFisrtRowTitle = fileFisrtRowTitle;
	}
