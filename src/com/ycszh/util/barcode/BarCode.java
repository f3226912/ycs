    ...
    implements Serializable
{
    ...
    protected void cxzl()
    {
        ...
        if(barType == 5)
        {
            if(checkCharacter)
                i++;
            vCx = i * (4D + 4D * N) * X + (1.0D + N) * X + (2D + N) * X;
        }
        if(barType == 4)
        {
            if(checkCharacter)
    ...
    protected void xzlk(Graphics g)
    {
        hJk = "";
        cxzl();
        tYu = (int)(topMarginCM * xCv);
        rTy = (int)(leftMarginCM * xCv);
        zLk = rTy;
        g.setColor(backColor);
        int i = getSize().width;
        ...
        if(showText && textFont != null)
        {
            ...
            if(rotate == 0 || rotate == 180)
            {
                ...
                if(barType == 15 || barType == 16)
                    height = (int)(wEr * xCv) + l + 11 + tYu;
            } else
            {
                width = cVb + l + tYu * 2;
                height = zLk + rTy + 2;
                if(barType == 15 || barType == 16)
                    width = (int)(wEr * xCv) + l + 11 + tYu;
            }
        } else
        if(rotate == 0 || rotate == 180)
        {
            ...
            width = zLk + rTy + 2;
            if(barType == 15 || barType == 16)
                height = (int)(wEr * xCv) + 1 + tYu;
        } else
        {
            width = cVb + tYu * 2;
            height = zLk + rTy + 2;
            if(barType == 15 || barType == 16)
                width = (int)(wEr * xCv) + 1 + tYu;
        }
        if(autoSize)
        ...
        if(showText && textFont != null)
        {
            ...
            if(barType == 15 || barType == 16)
            {
                ...
                if(l1 < 0)
                    l1 = 0;
                g.drawString(hJk, rTy + l1, (int)(wEr * xCv + i1 + 1.0D + tYu));
                lKj = (int)(wEr * xCv) + i1 + 1 + tYu;
                return;
            }
