	  ...
	  <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;
	    ...
	    <iframe id="abc" name="abc" width="0" height="0" style="display: none;"></iframe>
			...
			<form action="<%=request.getContextPath()%>/jyzwcj/jyzwcj_zwcjInsert.action" method="post" id="user_form" name="user_form" target="abc">
				<table border="0" cellpadding="0" cellspacing="0" class="edittable"  style="width: 90%;height: 90%";>
					...
					<tr>
						<td>部门编号</td>
						<td><input type="text" name="bmbh" value="${user[2]}" readonly="readonly" style="border: 0px;"/></td>
					</tr>
					...
					<tr>
						<td>状态</td>
						<s:if test="#request.user[7]==0">
							<td><input type="text" name="zt" value="未采集" readonly="readonly" style="border: 0px;"/></td>
						</s:if>
						<s:if test="#request.user[7]==1">
							<td><input type="text" name="zt" value="已采集" readonly="readonly" style="border: 0px;color: green;"/></td>
						</s:if>
						<!--<td><input type="text" name="zt" value="${user[7]}" readonly="readonly" style="border: 0px;"/></td>-->
					</tr>
					<tr>
						<td>采集人编号</td>
						<td><input type="text" name="czrbh" value="${userbean.name}" readonly="readonly" style="border: 0px;"/></td>
					</tr>
					<tr>
						<td>采集人部门</td>
						<td><input type="text" name="czrbm" value="${userbean.bmmc}" readonly="readonly" style="border: 0px;"/></td>
					</tr>
					<tr>
						<td>采集人姓名</td>
						<td><input type="text" name="czrxm" value="${userbean.ygxm}" readonly="readonly" style="border: 0px;"/></td>
					</tr>
					<tr style="display: none">
						<td>科级部门</td>
						<td><input type="text" name="kjbm" value="${user[11]}" style="border: 0px;"/></td>
					</tr>
					<tr>
						<td>采集时间</td>
						<td><input type="text" name="czsj" value="${user[12]}" style="border: 0px;"/></td>
					</tr>
					<tr style="display: none">
						<td>采集IP</td>
						<td><input type="text" name="czip" value="${user[13]}" style="border: 0px;"/></td>
					</tr>
					<tr style="display: none">
						<td>采集MAC</td>
						<td><input type="text" name="czmac" value="${user[14]}" style="border: 0px;"/></td>
					</tr>
					</s:iterator>
				</table>
			</form>
