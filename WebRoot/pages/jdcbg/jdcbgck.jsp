			...
			<div class="right" style="width:90%;">
				<table class="table1" width="100%" border="1" cellpadding="1" cellspacing="1">
					...
					<tr>
						...
						<td class="tdl" style="text-align: left;">
							<s:if test='#request.bgym.zhclzt=="1"&&#request.bgym.zhclhj=="888"'>
								<input type ="text" value='成功' disabled="disabled"/>
							</s:if>
							<s:elseif test='#request.bgym.zhclzt=="0"&&#request.bgym.zhclhj=="888"'>
								<input type ="text" value='失败' disabled="disabled"/>
							</s:elseif>
							<s:elseif test='#request.bgym.zhclhj=="18"'>
								<input type ="text" value='待受理' disabled="disabled"/>
							</s:elseif>
							<s:elseif test='#request.bgym.zhclhj=="2"'>
					...
					<s:if test='#request.bgym.zhclzt=="1"&&#request.bgym.zhclhj=="888"'>
						<tr>
							...
							<td class="tdl" style="text-align: left;">
								<input type ="text" value='${bgym.lsh }' disabled="disabled"/>
							</td>
						</tr>
					</s:if>
					<s:elseif test='#request.bgym.zhclzt=="0"&&#request.bgym.zhclhj=="888"'>
						<tr>
							...
							<td class="tdl" style="text-align: left;">
								<input type ="text" value='${bgym.zhclsm }' disabled="disabled"/>
							</td>
						</tr>
					</s:elseif>
					<s:elseif test='#request.bgym.zhclhj=="2"&&#request.bgym.zhclzt=="0"'>
						<tr>
							<td class="tds" style="text-align: right;">
								失败原因
							</td>
							<td class="tdl" style="text-align: left;">
								<input type ="text" value='${bgym.zhclsm }' disabled="disabled" size="50"/>
							</td>
						</tr>
					</s:elseif>
					<tr>
						...
						<td class="tdl" style="text-align: left;">
							<input type ="text" value='${bgym.zhclr }' disabled="disabled"/>
						</td>
					</tr>
					<tr>
						<td class="tds" style="text-align: right;">
						...
						<td class="tdl" style="text-align: left;">
							<input type="text" value="<s:date name="#request.bgym.zhclsj" format="yyyy-MM-dd HH:mm:ss"/>" disabled="disabled"/>
						</td>
					</tr>
					<tr>
						<td class="tds" colspan="2">
							<input type="button" value="返回" class="bnt" onclick="javascript:history.go(-1);"/>
						</td>
					</tr>
				</table>
			</div>
