	...
	<div class="content1" style="width:100%;">
		<div class="roundedBox" id="type1" style="width:95%;">
			<div class="right" style="width:90%;">
				<form action="<%=request.getContextPath()%>/jdcbg/jdcbg_jdcBgQuery.action" method="post" id="searchfromid">
				<table class="table1" width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="tdl" style="text-align: left;">
							<%--<s:select cssStyle="width:153px;" headerKey="" headerValue="---请选择---" 
								list="#request.zhr"  theme="simple" listKey="zhr" listValue="zhr" 
								name="zhclrs" value="#request.zhclrs" id="zhclrs"></s:select>
							--%>
					...
					<s:if test="bgList.size > 0">
						<s:iterator id="jdcbg" value="bgList" status="st">
							<tr class="<s:if test="#st.odd == false">altrow</s:if>">
								...
								<td>
									<s:date name="#jdcbg.zcdjrq" format="yyyy-MM-dd"/>
								</td>
								<td>
									${jdcbg.zhclr }
								</td>
								<td>
									<a href="#" onclick="ck('<s:property value="#jdcbg.wwlsh"/>')">【查看】</a>
								</td>
							</tr>
						</s:iterator>
					</s:if>
