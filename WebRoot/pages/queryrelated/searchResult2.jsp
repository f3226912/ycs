...
<script type="text/javascript">   
   ...
   function query(){
		...
		var url="<%=request.getContextPath()%>/qrelate/qrelate_qrelate2.action";
	 ...
	 <form id="queryForm" name="queryForm" method="post">
		<div style="width:95%;margin: 0 auto;">
		   <table  class="table1"  width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td class="tds" style="text-align: right;">录入时间:</td>
		  ...
		  <div style="width:95%; margin-top: 10px;margin: 0 auto;" id="printArea">
		   <div style="font-weight: bolder;color: red;">驾驶人联系方式变更业务数：${map.rscount}</div><br/>
