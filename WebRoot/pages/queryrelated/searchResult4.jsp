...
<script type="text/javascript">   
   ...
   function query(){
		...
		var url="<%=request.getContextPath()%>/qrelate/qrelate_qrelate4.action";
	...
	<body>
	 <form id="queryForm" name="queryForm" method="post">
		<div style="width:95%;margin: 0 auto;">
		   <table  class="table1"  width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    ...
			    <td class="tds" style="text-align: left;">
			    	<input type="text" name="startTime" id="startTime" class="Wdate" value="${request.startTime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false})" />
			    	到
			    	<input type="text" name="endTime" id="endTime" class="Wdate" value="${request.endTime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false})" />
		  ...
		  <div style="font-weight: bolder;color: red;">补换机动车行驶证业务数：${map.rscount}</div><br/>
