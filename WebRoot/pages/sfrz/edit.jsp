...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//disabled
		$("#dsrsfzmmc").click(function(){
			var sfzmmc=$("#dsrsfzmmc").val();
			if(sfzmmc!='A'){
				$("#dsrSfzCardname1").removeAttr("readonly");
				$("#dsrSfzCardsex1").removeAttr("readonly");
				$("#dsrSfzCardaddress1").removeAttr("readonly");
				$("#dsrSfzCardno1").removeAttr("readonly");
				$("#dsrSfzCardno1").removeAttr("class", "disabled");
				$("#dsrSfzCardname1").removeAttr("class", "disabled");
				$("#dsrSfzCardsex1").removeAttr("class", "disabled");
				$("#dsrSfzCardaddress1").removeAttr("class", "disabled");
				$("#file1").removeAttr("class", "disabled");
				openbnt("zp");
			}else{
				$("#dsrSfzCardname1").attr("readonly", "readonly");
				$("#dsrSfzCardsex1").attr("readonly", "readonly");
				$("#dsrSfzCardaddress1").attr("readonly", "readonly");
				$("#dsrSfzCardno1").attr("readonly", "readonly");
				$("#dsrSfzCardno1").attr("class", "disabled");
				$("#dsrSfzCardname1").attr("class", "disabled");
				$("#dsrSfzCardsex1").attr("class", "disabled");
				$("#dsrSfzCardaddress1").attr("class", "disabled");
				$("#file1").attr("class", "disabled");
				closebnt("zp");
			}
		...
		if ('查看' == edittype) {
			...
			$("#dsrsfzmmc").attr("disabled", "disabled");
...
<body onload="contentLoad();">
	...
	<div id=admin_main style="WIDTH:95%; margin:0 auto;margin: 25px;margin-top:15px;font-size: 12px;color: #000; z-index: -1000;">
		<div class="tab2">
			<ul id="test2_li_now_">
				<li onclick="settab(this,0)" class="now" style="width: 80px;">身份信息</li>
				<s:if test="#request.editType != '查看'">
					<li onclick="settab(this,1)" class="" style="width: 200px;">机动车/驾驶证档案</li>
					<li onclick="settab(this,2)" class="" style="width: 200px;">相片回执信息</li>
					<li onclick="settab(this,3)" class="" style="width: 200px;">单位信息</li>
				</s:if>
			</ul>
		</div>
		<div class="div">
			...
			<div id="tableid0" class="tablist block">
					...
					--%><tr>
						<td colspan="2" style="border-left: 0; border-right: 0;">&nbsp;&nbsp;
							...
							<s:else>
								...
								<input type="radio" name="sfrzCjxxb.rzjs" value="2" onclick="danwei()"/>&nbsp;普通单位
					...
					<tr>
						<td colspan="4" style="border-left: 0; border-right: 0;">&nbsp;&nbsp;
							身份证明名称：<s:select list="#{'A':'二代居民身份证','B':'组织机构代码证书',
										'C':'军官证','D':'士兵证','E':'军官离退休证','F':'境外人员身份证明','N':'社会统一信用代码',
							...
							<s:if test="'查看' != #request.editType">
								<input type="button" id="btnda" onclick="getda();" class="bnt" style="cursor: pointer; margin:0 0 5px 0;" value="查询档案"/>
							</s:if>
						</td>
					</tr>
				<table  class="edittable" border="0" cellpadding="0" cellspacing="0" align="center">
							...
							<table class="idcardclass" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td style="text-align: left; width:35%; border-left: 0px solid; border-top: 1px solid; border-bottom: 1px solid; border-right: 1px solid;">
										...
										'C':'军官证','D':'士兵证','E':'军官离退休证','F':'境外人员身份证明','N':'统一社会信用代码',
										'G':'外交人员身份证明','H':'居民户口薄','J':'单位注销证明',
										'K':'居住暂住证明','L':'驻华机构证明','M':'临时居民身份证'}" theme="simple"
											id="dsrsfzmmc"
						...
						<td colspan="4" style="border-left: 0; border-right: 0;">
							<div style="width: 48%; float: left;">
								<table id="dsrrtablesfz" class="edittable" border="0" cellpadding="0" cellspacing="0" align="center">
									<tr>
										<td colspan="3" style="border-top: 0px; border-left: 0;">&nbsp;
											<strong>当事人</strong> 
											<s:if test="'查看' != #request.editType">
									...
									<s:if test="#request.editType != '查看'">
										<tr>
											<td style="text-align: right; border-left: 0; border-right: 0;">&nbsp;照片路径：</td>
											<td colspan="2">
				...
				<table class="edittable" border="0" cellpadding="0" cellspacing="0" align="center">
				  ...
				  <s:if test="#request.editType != '查看'">
					  <tr>
						<td style="width: 25%" height="36" align="center" style="border-left: 0;">摄像头照片区域</td>
						<td style="width: 25%" align="center">高拍仪拍摄区域</td>
						<td style="width: 25%" align="center">当事人现场照片区域</td>
						<td style="width: 25%" align="center" style="border-right: 0;">证件正面图片（身份证、居住证、驾驶证、行驶证）</td>
					  </tr>
					  <tr>
						<td style="width: 25%" height="169" align="center" style="border-left: 0;">
						...
						<td style="width: 25%" align="center" style="border-right: 0;">
							<a id="img02a" href="" title="证件正面图片（身份证、居住证、驾驶证、行驶证）"><img src="<%=request.getContextPath()%>/images/cp.gif" id="img02" width="210" height="175" border="0"></a>
						</td>
					  </tr>
					  <tr>
						<td style="width: 50%" colspan="2" align="center" style="border-left: 0;">
						...
						<td style="width: 25%" width="102" align="center" style="border-right: 0;">
							<input type="file" name="file02" id="file02" class="disabled" title="请选择证件正面图片（身份证、居住证、驾驶证、行驶证）图片路径:C:\\printzj.jpg" style="width:210px;" />
						</td>
					  </tr>
					  <tr id="zj2">
						<!-- <td style="width: 25%" height="36" align="center" style="border-left: 0;">
							行驶证图片拍摄区域&nbsp;<input type="button" style="cursor:pointer;" name="zp4" id="zp4" value="抓拍" class="bnt" onclick="vide2(4);">
						</td> -->
						<td style="width: 25%" height="36" align="center" style="border-left: 0;">
							面签告知书（身份证件反面）&nbsp;<input type="button" style="cursor:pointer;" name="zp5" id="zp5" value="抓拍" class="bnt" onclick="vide2(5);">
						</td>
						<td style="width: 25%" height="36" align="center" style="border-left: 0;">
							手写板签名拍摄区域
						</td>
						<td style="width: 25%" colspan="2" height="36" align="center" style="border-left: 0;">
							<strong>
							       签字区域：            
				            </strong>
					  ...
					  <tr id="zja2">
						<td style="width: 25%" align="center" style="border-left: 0; padding-bottom: 3px;">
							<a id="img05a" href="" title="面签告知书（身份证件反面）"><img src="<%=request.getContextPath()%>/images/cp.gif" id="img05" width="210" height="175" border="0"></a>
							<input type="file" name="file05" id="file05" class="disabled" title="请选择面签告知书（身份证件反面）图片路径:C:\\printzj3.jpg" style="width:200px;" />
							<a href="javascript: delzjtp(5);">清空</a>
						</td>
						<td style="width: 25%" align="center" style="border-left: 0; padding-bottom: 3px;">
							<a id="img06a" href="" title="手写板签名拍摄区域"><img src="<%=request.getContextPath()%>/images/cp.gif" id="img06" width="210" height="175" border="0"></a>
							<input type="file" name="file06" id="file06" class="disabled" title="请选择手写板签名图片路径:C:\\printzj4.jpg" style="width:200px;" />
							<a href="javascript:Button3_onclick();">清空</a>
						</td>
						<td  style="width: 50%" height="169" colspan="2" align="center" style="border-left: 0; padding-bottom: 3px;">
				            <object id="HWPenSign"
				                   name="HWPenSign"
					  ...
					  <tr>
						<td colspan="3" style="border-left: 1px solid blue;border: 0px;display: none;" id="zwTd">
						<a id="ziwenLink" href="javaScript:showZhiWen()" style="color: red;font-size: 18;font-weight: bold;">点击采集指纹.....</a>
						<input type="hidden" id="fingerOne" name="finger1" value=""/>
						<input type="hidden" id="fingerThree" name="finger2" value=""/>
						<input type="hidden" id="fingerTwo" name="finger3" value=""/>
						<input type="hidden" id="fingerFour" name="finger4" value=""/>
						</td>
					  </tr>
					  <tr>
						<td colspan="4" align="center" style="border-left: 0; padding-bottom: 3px;">
							<input type="button" style="cursor:pointer;" onclick="javascript:dysqb();" value="打 印" id="dybnt" class="bnt3" />
							<input type="button" style="cursor:pointer;" onclick="javascript:subforms();" value="保 存" id="bcbnt" class="bnt3" />
						</td>
					  </tr>
					</s:if>
					<s:else>
					...
					<tr>
						...
						<tr>
							<td colspan="4" height="50" align="center"
								...
								<input type="button" id="guanbi" style="cursor:pointer;" onclick="javascript:window.close();" value="关 闭" class="bnt" />
							</td>
						</tr>
					</s:else>
				</table>
			...
			<div id="tableid1" class="tablist" style="text-align: center;height: 300px">
				<table border="1" cellpadding="0" cellspacing="0" id="datableid"  class="edittable">
					
				</table>
			</div>
			<div id="tableid2" class="tablist" style="text-align: center;height: 300px">
				<table border="1" cellpadding="0" cellspacing="0" id="datableid2"  class="edittable">
					
				</table>
			</div>
			<div id="tableid3" class="tablist" style="text-align: center;height: 300px">
				<table border="1" cellpadding="0" cellspacing="0" id="datableid3"  class="edittable">
				...
				<tr>
					<td class="tds" style="text-align: right;width: 17%;">
						...
						<td colspan="3" style="text-align: left;">
							&nbsp;<input type="text" class="disabled" id="sfzhm" name="sfzhm" size="30"/>&nbsp;&nbsp;
							<input class="bnt" type="button" value="添加" onclick="adddbr();" id="lshcx" style="cursor:pointer;" />
						</td>
				</tr>
			</table>
