...
<html>
 ...
 <style type="text/css">
	...
	.izImage {width: 580px;	height: 365px;cursor: pointerw;}		
			...
			<input type="hidden" name="dzxxb.cjxh" id="cjxh" value="${dzxxb.cjxh }"/><!--每一宗的主表cjxh  -->
				<table border="0" cellpadding="0" cellspacing="0" class="edittable"  style="width: 98%">
					...
					<tr>
						...
						<td colspan="4">
						 <div id="content" style="height:660px;width: 100%">
						    <s:if test="#request.photos.size > 0">
							      <s:iterator id="pto" value="#request.photos" status="st">
						               <div style="width:46%;height:580px;border:1px solid green;float:left;margin-left:10px;margin-top:10px;">
						                  <img id="idImage${pto.xh}"  class="izImage" src="http://100.100.21.61/cmp_new/view_pic.asp?efid=${pto.picStr}" style="height:500px;width:423px;"/>
