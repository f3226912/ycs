...
<script type="text/javascript">   
	//广告机构id
	var ggjgidAndZhzt = window.dialogArguments;
	var ggjgid="";
	var zhzt="";
	...
	$(function(){
		...
		function inital(){
			if(ggjgidAndZhzt==null || ggjgidAndZhzt==""){
				alert("无法获取要操作的广告机构id");
			}else{
				var tempStr=ggjgidAndZhzt.split(",");
				if(tempStr!=null && tempStr.length==2){
					ggjgid=$.trim(tempStr[0]);
					zhzt=$.trim(tempStr[1]);
					if(zhzt=="T"){
