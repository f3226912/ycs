...
<script type="text/javascript">   
	...
	//要审核的批次号集合
	var lshList = window.dialogArguments;
	...
	$(function(){
		...
		function inital(){
			if(lshList==null || lshList=="" || lshList.length<=0){
				alert("无法获取要审核的流水号");
			}
		}
		...
		$("#saveButton").click(function(){
			...
			if(typeof(lshList)!="undefined" && lshList!=null && lshList!=""){
				if(shztRadio.length==1){
					var result=initalData(lshList);
					...
					$.ajax({
						url: "<%=request.getContextPath()%>/gjgg/ycgg_updateBusGgjgclsbByLsh.action",
			  			type:'post',
			  			cache: false,
			  			async: true,
			  			dataType:'text',
	...
	<body>
	  <div style="width:100%;" >
	    ...
	    <table class="datalist" width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td class="tds1" style="text-align: right;width: 75px;">审核意见：</td>
			  ...
			  <tr id="tbyyTr" style="display: none;">
			    <td class="tds1" style="text-align: right;width: 75px;">退办原因：</td>
