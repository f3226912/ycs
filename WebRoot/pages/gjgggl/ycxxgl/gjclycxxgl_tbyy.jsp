...
<script type="text/javascript">
	...
	//要审核的批次号
	var pch = window.dialogArguments;
	...
	$(function(){
		...
		$("#saveButton").click(function(){
			if(typeof(pch)!="undefined" && pch!=null && pch!=""){
	...
	<body>
	  <div style="width:100%;" >
	    ...
	    <table class="datalist" width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr id="tbyyTr" >
			    <td class="tds1" style="text-align: right;">退办原因：</td>
		...
		<!-- 退办原因  -->
	   <div id="tbyyDiv" style="height:200px;width: 260px;display: none; position: absolute; background: #EDEDED"; >
		   <div id="checkboxDiv" style="width:100%; height:88%; padding:5px; overflow-y:scroll">
				<s:if test='#request.tbyyMap!=null && #request.tbyyMap.size()>0 '>
					<s:iterator value="#request.tbyyMap" var="tempTbyyMap">
						<div>
			...
			<div style="width:100%; height:12%; text-align:center; ">
			    <input type="button" onclick="chooseButton();" value="选择" />
			    <input type="button" onclick="clearChoose();" value="清除选择" />
			    <input type="button" onclick="hideTbyyDiv();" value="关闭" />
		    </div>
	   </div>
