...
<script type="text/javascript">
    ...
    function ck(){
    	window.mjclform.action='<%=request.getContextPath()%>/mjcl/mjcl_mjclQuery.action';
    ...
    function exportToExport(){
		...
		if(nodata.length>0){
	    	...
	    	t.action="<%=request.getContextPath()%>/mjcl/mjcl_mjclQueryExcel.action";
	    	t.submit();
		}
    }
    ...
    function opendept(){
        ...
        var uri="<%=request.getContextPath()%>/mjcl/mjcl_mjclDeptTj.action?s_date="+s_date+"&e_date="+e_date+"&count="+count+"";
        window.location.href=uri;
    	//window.showModalDialog(uri,null,"dialogHeight:600px;dialogWidth:700px;status:no;scroll:yes;center:yes");
    }
</script>
<style> 
	html{ 
...
<body style="background:#c7e5ff;">
	<div class="content1" style="width:100%;">
		<div class="roundedBox" id="type1" style="width:99%;">
			<div class="right" style="width:99%;">
				<form action="<%=request.getContextPath()%>/mjcl/mjcl_mjclQuery.action" method="post" id="searchfromid" name="mjclform">
					...
					<tr>
						<td class="tds" colspan="4">
							<div align="center">
								...
								<s:if test="#request.glbms==null">
									&nbsp;&nbsp;
									<input class="bnt" type="button" id="frombutid" value="部门统计" onclick="opendept()" style="cursor:pointer;"/>
								</s:if>
							</div>
						</td>
					</tr>
