	...
	<script type="text/javascript">
		...
		function exports(){
		    ...
		    var imgurl = '<%=request.getContextPath()%>/artDialog4.1.6/skins/icons/loading.gif';
			 ...
			 $("#esfrom").attr("action", "<%=request.getContextPath()%>/dydj/yhsl_initWarnDydj.action");
			 $("#esfrom").submit();
		}
    ...
    <div class="content1" style="width: 100%;">
		  <div class="roundedBox" id="type1" style="width: 95%;">
				<div class="right" style="width: 98%;">    
					...
					<br>
					<p style="color: red;font-size: 12px;">预警规则：在综合应用平台业务申报时间前90天之内未在互联网进行申报的数据。目前只对车牌号码进行核算预警。</p>
