...
<html>
	<head>
		<title>机动车补领行驶证/检验合格标志初审监管工作量统计</title>
 ...
 * @edate 结束日期
 */
function windowopenview(fpzh, lx, sdate, edate,ywlx) {
	window
			.open(
					'<%=request.getContextPath()%>/ezxfw/ezxfw_initJdcGzlView.action?fpzh='
							+ fpzh + '&lx=' + lx + '&sdate=' + sdate
							+ '&edate=' + edate+'&ywlx='+ywlx,
					'info',
					'width='
...
function exportToExport() {
	...
	if (nodata.length > 0) {
		...
		var uri = "<%=request.getContextPath()%>/ezxfw/ezxfw_ezxfwJdcGzlListExcel.action";
		...
		<div class="content1" style="width: 100%;">
			<div class="roundedBox" id="type1" style="width: 95%;">
				<div class="right" style="width: 98%;">
					<form
						action="<%=request.getContextPath()%>/ezxfw/ezxfw_initJdcGzlList.action"
						...
						<table class="table1" width="100%" border="0" cellpadding="0"
							...
							<tr>
								...
								<td class="tdl" style="text-align: left;" colspan="2">
					...
					<table class="datalist" width="100%" border="0" cellpadding="0"
						...
						<s:if test="#request.ezJdcGzlList.size > 0">
							<s:iterator id="dc" value="#request.ezJdcGzlList" status="st">
								<tr class="<s:if test="#st.odd == false">altrow</s:if>">
									...
									<td>
										<a href="javascript:void(0);"
											onclick="javascript:windowopenview('${dc[0] }','jdc','${s_date}','${e_date}','${dc[7]}');">点击查看详细</a>
									</td>
