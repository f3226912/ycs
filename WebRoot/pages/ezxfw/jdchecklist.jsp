...
<html>
	<head>
		<title>机动车补领行驶证/检验合格标志初审监管</title>
...
function windowopenview(fpzh, lx, sdate, edate,ywlx) {
	window
			.open(
					'<%=request.getContextPath()%>/ezxfw/ezxfw_initJdcCheckView.action?fpzh='
...
function exportToExport() {
	...
	if (nodata.length > 0) {
		...
		var uri = "<%=request.getContextPath()%>/ezxfw/ezxfw_ezxfwJdcListExcel.action";
		...
		<div class="content1" style="width: 100%;">
			<div class="roundedBox" id="type1" style="width: 95%;">
				<div class="right" style="width: 98%;">
					<form
						action="<%=request.getContextPath()%>/ezxfw/ezxfw_initJdcCheckList.action"
					...
					<table class="datalist" width="100%" border="0" cellpadding="0"
						...
						<s:if test="#request.ezJdcCheckList.size > 0">
							<s:iterator id="dc" value="#request.ezJdcCheckList"
								status="st">
