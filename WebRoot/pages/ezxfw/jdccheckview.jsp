...
function exportToExport() {
	...
	if (nodata.length > 0) {
		...
		var uri = "<%=request.getContextPath()%>/ezxfw/ezxfw_ezxfwJdcExcel.action";
			...
			<div class="roundedBox" id="type1" style="width: 95%;">
				<div class="right" style="width: 98%;">
					...
					<table class="datalist" width="100%" border="0" cellpadding="0"
						...
						<s:if test="#session.ezJdcCheckView.size > 0">
							<s:iterator id="dc" value="#session.ezJdcCheckView" status="st">
