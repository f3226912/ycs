...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if('查看' == edittype){
			$("#tableid0 input").attr("disabled","disabled");
			$("#tableid1 input").attr("disabled","disabled");
			$("#tableid2 input").attr("disabled","disabled");
			$("#tableid0 select").attr("disabled","disabled");
...
<body>
	...
	<div id=admin_main style="WIDTH:95%; margin:0 auto;margin: 25px;margin-top:15px;font-size: 12px;color: #000; z-index: -1000;">
		...
		<div class="div">
			...
			<input type="hidden" name="dbZjxxb.lsh" id="lshval" value="${request.lsh}"/>
			<input type="hidden" name="dbZjxxb.hphm" id="hphmval" value="${request.hphm}"/>
			<input type="hidden" name="dbZjxxb.hpzl" id="hpzlval" value="${request.hpzl}"/>
			<input type="hidden" name="dbZjxxb.clsbdh" id="clsbdhval" value="${request.clsbdh}"/>
			<input type="hidden" name="dbZjxxb.ywlx" id="ywlx" value=""/>
			<input type="hidden" name="dbZjxxb.ywyy" id="ywyy" value=""/>
			<input type="hidden" name="syxz" id="syxz" value=""/>
...
<!-- 证件信息页面 ===================================================-->			
			<div id="tableid0" class="tablist block">
				<table class="edittable" border="0" cellpadding="0" cellspacing="0" align="center">
					<tr>
						<td>&nbsp;&nbsp;业务类型：${dbZjxxb.ywlx}</td>
						<td width="50%" style="text-align: center;">采集信息</td>
					</tr>
					<tr>
						<td style="height: 30px;">
							&nbsp;&nbsp;号牌号码：<input class="dis" type="text" name="dbZjxxb.hphm" value="${dbZjxxb.hphm}" id="hphm"/>
							&nbsp;&nbsp;&nbsp;&nbsp;号牌种类：
			...
			<div id="tableid1" class="tablist" style="text-align: center;height: 300px">
				...
				<table border="1" cellpadding="0" cellspacing="0" id="tabCc1"  class="edittable">
					...
					<tr>
						...
						&nbsp;<input type="text" class="disabled" id="ptdosyr"  name="ptdo.syr" value="${ptdo.czmc}" size="17" /></td></td>
					
						<td style="text-align:right;"><font style="color:red;">*</font>移动电话：</td>
						<td class="trs" style="text-align: left;">&nbsp;<input type="text" class="disabled" id="ptdolxdh" value="${ptdo.sjhm}" name="ptdo.sjhm" size="17" maxlength="50"/></td>
					...
					<tr>
						...
						<td class="trs" colspan="3" style="text-align: left;">&nbsp;<select id="yzbm6" name="yzbm6">
															<option value="">===请选择===</option>
															<s:iterator var="yzbm" value="#request.yzbmList">
																<option value="<s:property value="#yzbm.dmz" />" <s:if test="#request.ptdo.zzxzqh == #yzbm.dmz">selected="selected"</s:if>><s:property value="#yzbm.dmsm1" /></option>
															</s:iterator>
														</select>
					...
					<tr>
						...
						<td class="trs" style="text-align: left;">&nbsp;<input type="text" class="disabled" id="ptdosxrq" value="" name="ptdo.sxrq" size="10" maxlength="20" />
						</td>
						
						<td style="text-align:right;">保险终止日期：</td>
						<td class="trs" style="text-align: left;">&nbsp;<input type="text" class="disabled" id="ptdozzrq" value="}" name="ptdo.zzrq" size="10" maxlength="20"/>
						</td>
						<td></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3" align="left" style="width: 196px height: 21px;text-align: left;">&nbsp;<input name="ptdo.tempBz2" id="ptdotempBz2"  class="disabled" value="" size="60" maxlength="100" type="text" />
						</td>
						<td>
						</td>
						<td></td>
			...
			<div id="tableid2" class="tablist" style="text-align: center;height: 420px">
				...
				<table border="1" cellpadding="0" cellspacing="0" id="tabCc3" class="edittable">
					<tr>
						...
						<td class="trs" colspan="3" style="text-align: left;">&nbsp;<input type="text" id="ptdoclsbdh" value="${ptdo.clsbdh}" name="ptdo.clsbdh" size="30" maxlength="100"/>&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;
						</td>
						<td>
						</td>
					...
					<tr>
						...
						<td class="trs" colspan="3" style="text-align: left;">
							&nbsp;<input type="text" class="disabled" readonly="readonly" id="ptdoclxh" value="${ptdo.xh}" name="ptdo.clxh" size="30" maxlength="32"/>&nbsp;&nbsp;&nbsp;&nbsp;
							 &nbsp;
						</td>
						<td style="text-align:right;">
							中文品牌：
						</td>
						<td class="trs" style="text-align: left;">&nbsp;<input type="text" class="disabled" id="ptdoclpp1" value="" name="ptdo.clpp1" size="20" maxlength="16"/>
						</td>
					</tr>
					<tr>
						<td style="text-align:right;">英文品牌：</td>
						<td class="trs"  colspan="3" style="text-align: left;">
						&nbsp;<input type="text" class="disabled" id="ptdoclpp2" value="" name="ptdo.clpp2" size="30" maxlength="16"/></td>
					...
					<tr>
						...
						<td class="trs" colspan="3" style="text-align: left;">&nbsp;<input type="text" class="disabled" id="ptdozzcmc" value="${ptdo.cj}" name="ptdo.zzcmc" size="30" maxlength="64"/>
						</td>
					...
					<tr >
						...
						&nbsp;<input type="text" class="disabled" id="ptdojkpzhm" value="" name="ptdo.jkpzhm" size="20" maxlength="30"/>
						</td>
